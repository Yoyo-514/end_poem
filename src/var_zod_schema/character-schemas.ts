import { SHIRO_ABILITIES, getUserName } from './constants';
import {
  appearance,
  clampedNum,
...
export const createPrimaryCharactersSchema = () =>
  z
    .object({
      白: z
        .object({
          ...
          能力: z
            .any()
            .prefault([...SHIRO_ABILITIES])
            .transform(locked([...SHIRO_ABILITIES])),
        })
        .prefault({}),
      ...
      [getUserName()]: UserRoleSchema,
    })
    .prefault({});

export const SpecialCharactersSchema = z
  .object({
    Lily: z
      .object({
